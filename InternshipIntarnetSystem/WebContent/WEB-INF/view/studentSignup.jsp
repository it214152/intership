...
<div id="wrapper" class="c1">
		...
		<div>
			<h2>Δήλωση Ενδιαφέρντος Συμμετοχής σε Πρακτική Άσκηση</h2>
		</div>
		
		<form action="/action_page.php" method="post" style="background-color: white">
				
				<p class="textp">Για να δηλώσετε συμμετοχή πατήστε το κουμπί παρακάτω.<br></p>
				<button id="painN3" type="submit">Συμμετοχή <i class="fa fa-check"></i></button>
			</div>
		</form>
