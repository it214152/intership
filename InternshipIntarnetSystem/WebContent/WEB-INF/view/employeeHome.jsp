...
<div id="wrapper" class="c1">
		...
		<div>
			<h2>Αχική Σελίδα</h2>
			<p class="textp"><b>Καλωσορίσατε στο σύστημα πρακτικής άσκησης του πανεπιστημίου μας.</b><br><br>Μέσω της πλατφόρμας αυτής γίνεται ευκολότερη η διαχήρηση των θέσεων πρακτική άσκησης, καθώς και των ενδιαφερόμενων φοιτητών.<br><br>Ελένξτε ότι όλοι οι συμμετέχοντες πληρούν τα κριτήρια και διαχηριστείτε τους ανάλογα.<br><br></p>
		</div>
