...
<!DOCTYPE html>
		<div id="wrapper" class="c1">
		 ...
		 --><div id="navbar" class="c1"><!--
				--><ul>
				  ...
				  <li><a href="#news"><i class="fa fa-list-ol"></i> Κριτήρια</a></li>
				  <li><div class="dropdown">
					...
					<div class="dropdown-content">
					  <a href="#">Νέα Δήλωση</a>
					  <a href="#">Προβολή Δηλώσεων</a>
					  <a href="#">Προβολή Αποδεκτών Δηλέσεων</a>
					</div>
  </div> 
				  <li><a href="#about"><i class="fa fa-bell"></i> Ανακοινώσεις</a></li> 
				</ul>
			</div>
		</div>
		...
		<div>
			<h2>Ανακοινώσεις</h2>
			<p class="textp">Παρακάτω βλέπετε όλες τις ανακοινώσεις.</p>
		</div>
		
		<div>
				<div class="container">
					<b>Παράταση Προθεσμίας</b><br><br>
					 Η προθεσμία υποβολής των επιθημητών θέσεων πρακτηκής άσκησης μεταφέρθηκε για τις xx/xx/xxxx.<br>	
			</div>
			<br>
			<br>
			<div>
				<div class="container">
					<b>Προθεσμία Δήλωσης</b><br><br>
					Μπορείτε να δηλώσετε ποιές θέσεις πρακτικής άσκησης μέχρι τις yy/yy/yyyyy.<br>	
			</div>
			<br>
			<br>
			<div class="container">
					<b>Παράταση Προθεσμίας</b><br><br>
					 Η προθεσμία υποβολής των επιθημητών μαθητών για τις θέσεις πρακτηκής άσκησης μεταφέρθηκε για τις xx/xx/xxxx.<br>	
			</div>
			<br>
			<br>
			<div>
				<div class="container">
					<b>Προθεσμία Δήλωσης</b><br><br>
					Μπορείτε να δηλώσετε ποιοί μαθητές σας ενδιαφέρουν για τις θέσεις πρακτικής άσκησης μέχρι τις yy/yy/yyyyy.<br>	
			</div>
		...
		<div id="footer">
			...
			<div id="footerL" class="footerD"> 
				<br>
				<p>Σύστημα Πρακτικής Άσκησης - Σύστημα Εξυπηρέτησης Προσωπικού</p>
